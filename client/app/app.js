...
.run(['ParseSDK','Facebook', '$cookieStore', '$rootScope', '$state', '$stateParams', 'User', 'AuthDb', 'SongFile', function(ParseService,Facebook, $cookieStore, $rootScope, $state, $stateParams, User, AuthDb, SongFile) {
